...
const CoreViewButton = styled('button', coreButtonRecipe, {
  ...
  view: ({
    ...
    'disabled'
  >) => {
    type _CoreViewTone = Expect<
      Equal<typeof variants.tone, 'neutral' | 'accent'>
    >;
...
const CoreField = styled('label', coreFieldRecipe, {
  view: ({
    ...
    return host.render({
      children: [
        createElement('span', { className: classes.label() }, host.children),
        createElement('input', { className: classes.input() }),
      ],
    });
  },
});
